...
function App() {
  const [noLabel, setNoLabel] = useState(config.content.noButtonText || "NO 💔");
  ...
  const handleNoLeave = useCallback(() => {
    if (hoveredOnce) {
      setNoLabel(config.content.noButtonText || "NO 💔");
    }
  }, [hoveredOnce]);
        ...
        <div className="card gifts-card">
          ...
          <div className="gifts-container">
            <div className="gift-card" onClick={handleGift1Click}>
              <h3 className="gift-title">🎵 Love Playlist</h3>
              <div className="gift-image">
                <img src={config.gifts.gift1} alt="🎵 Love Playlist" loading="lazy" />
              </div>
            </div>

            <div className="gift-card" onClick={handleGift2Click}>
              <h3 className="gift-title">💌 Love Letter</h3>
              <div className="gift-image">
                <img src={config.gifts.gift2} alt="💌 Love Letter" loading="lazy" />
              </div>
            </div>

            <div className="gift-card" onClick={handleGift3Click}>
              <h3 className="gift-title">📸 Our Photos</h3>
              <div className="gift-image">
                <img src={config.gifts.gift3} alt="📸 Our Photos" loading="lazy" />
              </div>
            </div>
          </div>
  ...
  {/* ✅ scroll area so letter never gets cut */}
